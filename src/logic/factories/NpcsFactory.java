...
public class NpcsFactory {
    ...
    public static final Npc general = new Npc("general", "General",false, 150.0, 20.0, true, Arrays.asList(
            "General: Who are you!",
    ...
    public static final Npc dungeonGuard = new Npc("guard", "Guard",false, 100.0, 5.0, true, Arrays.asList(
    ...
    public static final Npc brutalGuard = new Npc("brutal_guard", "Brutal guard",false, 130.0, 20.0, false, null,
            null);
    public static final Npc frog = new Npc("frog", "Frog",false,50.0, 1.0, false, null, null);
    public static final Npc gorm = new Npc("gorm", "Gorm",true, 100.0,100.0, true, Arrays.asList(
    ...
    public static final Npc gateGuard = new Npc("gate_guard", "Gate guard",true, 100.0, 100.0, true, Arrays.asList(
    ...
    public static final Npc passageGuard = new Npc("passage_guard", "Passage guard",true, 100.0, 100.0, true, Arrays.asList(
    ...
    public static final Npc wolf = new Npc("wolf", "Wolf",false,80.0, 3.0, false, null, null);
    public static final Npc bear = new Npc("bear", "Bear",false, 80.0, 3.0, false, null, null);
    public static final Npc rat = new Npc("rat", "Rat",false,90.0, 3.0, false, null, null);
    ...
    public static final Npc tue = new Npc("tue", "Tue",true, 1.0,1.0, true, Arrays.asList(
            "...",
            "...",
            "........."), null);
    public static final Npc girl = new Npc("girl", "Girl",true, 100.0,100.0, true, Arrays.asList(
    ...
    public static final Npc beggar = new Npc("beggar", "Beggar",true, 100.0, 100.0, true, Arrays.asList(
